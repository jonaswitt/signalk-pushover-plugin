        ...
        <div>
            {(() => {
                if (!isStateKnown || isStateOld) {
                    return (
                        <div
                            className={`${commonDivStyle} bg-gray-400 text-white`}
                        >
                ...
                if (isAnchorUp) {
                    return (
                        <div
                            className={`${commonDivStyle} bg-yellow-400 text-gray-700`}
                        >
                            Anchor Up
                        </div>
                    );
                ...
                const range = (
                    <>
                        ...
                        m @{" "}
                        {anchorBearing != null
                            ? ((Number(anchorBearing) * 180) / Math.PI).toFixed(
                                  0,
                              )
                            : "?"}
                        ° <br />
                ...
                if (isAlarm) {
                    return (
                        <div
                            className={`${commonDivStyle} bg-red-700 text-white`}
                        >
                            ALARM <br />
                            {range}
                        </div>
                ...
                return (
                    <div
                        className={`${commonDivStyle} bg-green-700 text-white`}
                    >
                        Anchor Set <br />
                        {range}
                    </div>
